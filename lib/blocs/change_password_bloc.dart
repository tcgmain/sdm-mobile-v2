...
class ChangePasswordBloc {
  ...
  StreamSink<Response<ChangePassword>> get changePasswordSink => _changePasswordController!.sink as StreamSink<Response<ChangePassword>>;
  Stream<Response<ChangePassword>> get changePasswordStream => _changePasswordController!.stream as Stream<Response<ChangePassword>>;
  ...
  changePassword(String newpassword, loginId) async {
    ...
    try {
      ChangePassword res = await _changePasswordRepository.changeNewPassword(newpassword,loginId);
